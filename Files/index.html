...
<form id="evento" name="cadastra_evento" method="POST" action="">

	<label for="palestrante">Nome Completo do Palestrante(sem abreviações):</label>
	<input required type="text" id="nome_palestrante" name="palestrante" placeholder="Seu Nome" />

	<label>Nome da Palestra ou Evento:</label>
	<input required type="text" id="evento" name="evento" placeholder="" />

	<label>Data e Hora do evento:</label>
	<input required type="datetime-local" id="data_evento" name="data" placeholder="" />
